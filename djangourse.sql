...
--
-- Host: localhost:8889
-- Generation Time: Nov 27, 2024 at 05:17 AM
...
--
ALTER TABLE `favourite_courses`
  ADD CONSTRAINT `fk_favourite_courses_to_courses` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `fk_favourite_courses_to_students` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--
ALTER TABLE `transactions`
  ADD CONSTRAINT `fk_transactions_to_courses` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `fk_transactions_to_students` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
