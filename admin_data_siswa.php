...
<head>
    ...
    <style>
        :root {
            ...
            --sidebar: #ffffff; /* Sidebar background color */
        }
...
.card-content {
    ...
    flex-direction: column;
    align-items: center;
    background-color: #1e8881; /* Background color of the card */
    color: #ffffff;            /* Text color */
    padding: 20px;             /* Padding around the content */
    border-radius: 10px;       /* Rounded corners */
    box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); /* Soft shadow */
    width: 309px;              /* Set a fixed width */
    text-align: center;
    margin-left: 30px;
}
...
.card-content p {
    font-size: 40px;           /* Font size for the number */
    margin: 10px 0 0;          /* Margin above and below */
    font-weight: bold;
}
...
.pembelian-box {
    width: 192%; /* Ensures the inner box also spans the full width */
    overflow-x: auto;
...
.pembelian-box small {
    ...
    font-size: 12px;
        ...
        .table_student_coins table th, table td{
            padding: 15px;
            text-align: left;
        }
...
<div class="container">
    <div class="sidebar">
        ...
        <div class="sidebar">
            <nav>
                ...
                <a href="#">
                    <img src="assets/persetujuan-penarikan.png" alt="Instructor Logo" class="icon"/>
                    <p>Persetujuan Penarikan</p>
                </a>
                <a href="#">
                    <img src="assets/setting.png" alt="Pengaturan Logo" class="icon"/>
                    <p>Pengaturan</p>
                </a>
            </nav>
        </div>
    ...
    <div class="jumlah-siswa-card">
        <div class="card-content">
            <img src="assets/image-4.png" alt="Icon" class="icon">
            <h3>Jumlah Siswa</h3>
            <p>0</p>
        </div>
    </div>
