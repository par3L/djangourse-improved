    ...
    fetch(`course-list.php?kategori=${category}&offset=${offset}`)
        ...
        .then(data => {
            ...
            data.courses.forEach(course => {
                const courseHTML = `
                    <div class="catalog" data-category="${course.category_name}">
                        ...
                        <img class="course-image" src="${course.thumbnail}" alt="Thumbnail Kursus">
                        <div class="catalog-footer">
                            <div class="koin">${new Intl.NumberFormat('id-ID').format(course.price)} Koin</div>
...
document.getElementById('loadMore').addEventListener('click', function () {
    ...
    loadCourses(kategoriSaatIni, offset);
});
