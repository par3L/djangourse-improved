...
<head>
    ...
    <link rel="stylesheet" href="./admin-instructor.css">
    <style>
    </style>
</head>
<body>
<div class="container">
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            <img alt="Logo" src="./cur_assets/django-3.png"/>
        </div>
        <div class="sidebar">
            <nav>
                <a href="#">
                    <img src="./cur_assets/dashboard.png" alt="Profil Logo" class="icon"/>
                    <p> Dashboard</p>
                </a>
                <a href="#">
                    <img src="./cur_assets/siswa.png" alt="Login Logo" class="icon"/>
                    <p>Siswa</p>
                </a>
                <a href="#">
                    <img src="./cur_assets/pengajar.png" alt="Register Logo" class="icon"/>
                    <p>Pengajar</p>
                </a>
                <a href="#">
                    <img src="./cur_assets/persetujuan-penarikan.png" alt="Instructor Logo" class="icon"/>
                    <p>Persetujuan Penarikan</p>
                </a>
                <a href="#">
                    <img src="./cur_assets/setting.png" alt="Pengaturan Logo" class="icon"/>
                    <p>Pengaturan</p>
                </a>
            </nav>
        </div>
    ...
    <div class="main-content">
        ...
        <div class="inst-count">
            <img src="./cur_assets/total-pengajar.png" alt="">
        ...
        <div class="course">
            ...
            <div class="endpoint">
                ...
                <div class="right-content">
                    ...
                    <img src="./cur_assets/place_holder.png" alt="">
                    <h1>0</h1>
                </div>
            </div>
        </div>
